...
public class ServerDriver
{
     ...
     * Implementation, creates new threads for StockTracker and allows for
     * remote method calling between Client and Server
     * <p/>
     * @param args <p/>
     * @throws Exception
     */
    public static void main(String[] args) throws Exception
    {
        ...
        //Create a thread to run StockTracker class separetly to update stock prices frequently
        Thread stockTrackerThread = new Thread(new StockTracker());

        //Start the StockTracker thread
